...
## 9) Phase-1 Contract Freeze Artifacts

- `spec/SLICE0_PHASE1_CONTRACT_FREEZE.md`
...
- `spec/samples/contracts/fail_closed_matrix.slice0.json`
- `tests/test_slice0_contract_freeze.py`

These artifacts form the Phase-1 contract gate and must pass CI before Slice-0 implementation starts.
